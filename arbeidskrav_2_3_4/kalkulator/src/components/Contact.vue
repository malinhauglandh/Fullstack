...
const inputName = ref(store.state.name);
const inputEmail = ref(store.state.email);
const inputFeedback = ref(store.state.feedback);
let submitted = false;
...
function updateStore() {
  ...
  store.commit('setEmail', inputEmail.value);
  store.commit('setFeedback', inputFeedback.value);
}
